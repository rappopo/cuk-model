...
module.exports = function(cuk) {
  ...
  return new Promise((resolve, reject) => {
    helper('core:bootTrace')('%A Creating connector...', null)
    _.each(helper('core:pkgs')(), p => {
      ...
      _.forOwn(cfg, (c, name) => {
        ...
        let dir
        helper('core:bootTrace')('%B %s:%s (%s)', null, p.id, name, c.dab)
        try {
          dir = helper('core:utilNpmPkgDir')(c.dab, __dirname + '/..')
        } catch(e) {
      ...
      _.forOwn(cfg, (c, name) => {
        ...
        let values = helper('core:utilSplitPkgToken')(c)
